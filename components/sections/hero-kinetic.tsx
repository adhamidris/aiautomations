...
export const HeroKinetic = ({
  ...
  return (
    <section className="relative w-full bg-background text-foreground selection:bg-foreground/20 overflow-x-hidden min-h-[100svh] md:h-screen md:overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 z-0 hidden h-[360px] w-[80vw] -translate-x-1/2 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-foreground/7 via-foreground/3 to-transparent blur-3xl pointer-events-none will-change-transform md:block" />

      {/* Direct Spotlight - Root Level */}
      <div className="absolute left-1/2 top-[15%] z-0 hidden h-[320px] w-[70vw] max-w-[600px] -translate-x-1/2 rounded-full bg-foreground/[0.04] blur-[120px] pointer-events-none will-change-transform md:block" />
        ...
        >
          <div className="relative flex items-center justify-center w-full max-w-5xl mx-auto py-4 sm:py-8 lg:py-12">
            ...
            <h1 dir="ltr" className="font-heading font-black text-[14vw] md:text-[12vw] leading-none text-foreground select-none pointer-events-none opacity-100 tracking-tighter flex flex-col items-center md:flex-row md:items-baseline md:justify-center w-full px-4">
              <span>AUTOM8ED</span>
              <span className="self-end md:self-auto mt-0 text-[0.25em] text-muted-foreground font-mono tracking-normal opacity-80 md:mt-0 md:text-[0.15em] md:animate-glitch" data-text=".space">.space</span>
            </h1>
          </div>
