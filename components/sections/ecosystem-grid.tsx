      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 md:mb-24">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-foreground tracking-tight">
            ...
            <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-foreground via-foreground/80 to-foreground">
              Automate Everything.
            </span>
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
          ...
          <div className="flex flex-col items-center justify-center text-center h-full min-h-[220px] p-8">
            ...
            >
              <span className="text-xs font-mono uppercase tracking-widest font-semibold">TELL US MORE</span>
