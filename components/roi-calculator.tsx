...
export const RoiCalculator = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 md:p-8">
      <div className="rounded-2xl border border-border bg-card/50 p-6 md:p-10 backdrop-blur-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex justify-between text-sm">
                <label className="text-foreground/80">Manual Hours / Week</label>
            ...
            <div className="space-y-4">
              <div className="flex justify-between text-sm">
                <label className="text-foreground/80">Hourly Cost ($)</label>
          ...
          <div className="flex flex-col items-center justify-center p-6 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-center">
            <div className="text-sm text-muted-foreground mb-2">Potential Annual Savings</div>
            <motion.div
            ...
            <Button className="w-full bg-foreground text-background hover:opacity-90 transition-opacity">
              Start Saving Now
            </Button>
          </div>
        </div>
